...
SpriteSheet.Register("leader", {
    path = "image/shadow_lord_spritesheet_20260406122430.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册N级英雄精灵图
SpriteSheet.Register("grunt", {
    path = "image/skeleton_grunt_sprite_20260406174256.png",
    cols = 2,   -- 0=idle, 1=attack（近战，无弹体帧）
})
SpriteSheet.Register("bat_m", {
    path = "image/bat_minion_sprite_20260406173923.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("hound", {
    path = "image/hell_hound_sprite_20260406173937.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册R级英雄精灵图
SpriteSheet.Register("archer", {
    path = "image/skeleton_archer_sprite_20260406192151.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("demon", {
    path = "image/demon_warrior_sprite_20260406191908.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("assassin", {
    path = "image/ghost_assassin_sprite_20260406191907.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("golem", {
    path = "image/stone_golem_sprite_20260406191909.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册SR级英雄精灵图
SpriteSheet.Register("necro", {
    path = "image/necromancer_sprite_20260406192917.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("flame", {
    path = "image/inferno_flame_sprite_20260406193925.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("knight", {
    path = "image/armor_breaker_sprite_20260406192916.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("witch", {
    path = "image/frost_witch_sprite_20260406193006.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("drummer", {
    path = "image/war_drummer_sprite_20260406193002.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册SSR级英雄精灵图
SpriteSheet.Register("mage", {
    path = "image/shadow_mage_sprite_20260406194358.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("hunter", {
    path = "image/abyss_hunter_sprite_20260406200528.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("plague", {
    path = "image/plague_doctor_sprite_20260406202109.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("storm", {
    path = "image/storm_lord_sprite_20260406194510.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册UR级英雄精灵图
SpriteSheet.Register("archangel", {
    path = "image/fallen_archangel_sprite_20260406194524.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("dragon", {
    path = "image/void_dragon_sprite_20260406194522.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})

-- 注册LR级英雄精灵图
SpriteSheet.Register("weaver", {
    path = "image/fate_weaver_sprite_20260406195007.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
SpriteSheet.Register("archfiend", {
    path = "image/eternal_archfiend_sprite_20260406195006.png",
    cols = 3,   -- 0=idle, 1=attack, 2=projectile
})
-- ========== Debuff 粒子系统 ==========
...
local particleTexPaths = {
    ice     = "image/particle_ice_20260406204209.png",
    star    = "image/particle_star_20260406204206.png",
    frozen  = "image/particle_frozen_20260406204223.png",
    armor   = "image/particle_armor_20260406204221.png",
    curse   = "image/particle_curse_20260406204220.png",
    poison  = "image/particle_poison_20260406204210.png",
}
