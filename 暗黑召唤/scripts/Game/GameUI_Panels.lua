            ...
            ctx.UI.Panel {
                ...
                children = {
                    ...
                    ctx.UI.Button {
                        ...
                        paddingLeft = 10, paddingRight = 10,
                        onClick = function(self)
                            if not State.IsAutoUnlockedToday("autoSummon") then
                                ...
                                if sdk and sdk.ShowRewardVideoAd then
                                    ...
                                    sdk:ShowRewardVideoAd(function(success)
                                        if success then
                                            AdTracker.Record()
                                            State.RecordAutoAdUnlock("autoSummon")
                                            State.autoSummon = true
                            ...
                            State.autoSummon = not State.autoSummon
                            State.autoSummonTimer = 0
                            GameUI.UpdateHUD()
                        end,
                    },
                    ...
                    ctx.UI.Button {
                        ...
                        paddingLeft = 10, paddingRight = 10,
                        onClick = function(self)
                            if not State.IsAutoUnlockedToday("autoMerge") then
                                ---@diagnostic disable-next-line: undefined-global
                                if sdk and sdk.ShowRewardVideoAd then
                                    ---@diagnostic disable-next-line: undefined-global
                                    sdk:ShowRewardVideoAd(function(success)
                                        if success then
                                            AdTracker.Record()
                                            State.RecordAutoAdUnlock("autoMerge")
                            ...
                            State.autoMerge = not State.autoMerge
                            State.autoMergeTimer = 0
                            GameUI.UpdateHUD()
                        end,
                    },
                    ...
                    ctx.UI.Button {
                        ...
                        paddingLeft = 10, paddingRight = 10,
                        onClick = function(self)
                            if not State.IsAutoUnlockedToday("autoDeploy") then
                                ---@diagnostic disable-next-line: undefined-global
                                if sdk and sdk.ShowRewardVideoAd then
                                    ---@diagnostic disable-next-line: undefined-global
                                    sdk:ShowRewardVideoAd(function(success)
                                        if success then
                                            AdTracker.Record()
                                            State.RecordAutoAdUnlock("autoDeploy")
                            ...
                            State.autoDeploy = not State.autoDeploy
                            State.autoDeployTimer = 0
                            GameUI.UpdateHUD()
                        end,
                    },
