    ...
    if nextChestDef then
        rightChild = UI.Panel {
            ...
            children = {
                ...
                UI.Panel {
                    ...
                    children = {
                        UI.Panel {
                            ...
                            backgroundImage = "image/chest_base_20260407155346.png",
                ...
                UI.Label {
                    text = canClaim and "领取奖励" or "暂未激活",
                    fontSize = 8,
                    fontColor = canClaim and { 100, 230, 100, 255 } or { 140, 130, 160, 180 },
                },
            },
        }
    else
                    ...
                    UI.Panel {
                        ...
                        children = {
                            UI.Panel {
                                width = "100%",
                                aspectRatio = 1,
                                backgroundImage = "image/score_badge_20260407160530.png",
                                backgroundFit = "contain",
                            },
                        },
                    },
