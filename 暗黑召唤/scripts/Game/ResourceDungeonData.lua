...
RD.DUNGEON_DEFS = {
    {
        ...
        bonusCurrency  = nil,
        cover          = "image/dungeon_crystal_mine_20260408201736.png",
    },
    {
        key            = "stone",
        name           = "噬魂深渊",
        ...
        bonusCurrency  = nil,
        cover          = "image/dungeon_soul_abyss_20260408201726.png",
    },
    {
        key            = "iron",
        name           = "锻魂熔炉",
        ...
        bonusCurrency  = nil,
        cover          = "image/dungeon_forge_20260408201733.png",
    },
    {
        key            = "chest",
        name           = "宝箱秘境",
        ...
        bonusCurrency  = nil,
        cover          = "image/dungeon_treasure_20260408201733.png",
    },
}
...
function RD.CalcHPScale(stageEquiv)
    local s = stageEquiv
    return (Config.STAGE_HP_BASE + Config.STAGE_HP_PER_STAGE * (s - 1))
         * (Config.STAGE_HP_EXPO ^ (s - 1))
end
