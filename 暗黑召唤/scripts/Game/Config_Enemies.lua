...
Config.AFFIXES = {
    ...
    { id = "shielded",  name = "护盾", tier = 2, color = { 200, 200, 255 },
      shieldHP = 0.5 },
    { id = "stealth",   name = "隐匿", tier = 2, color = { 120, 120, 160 },
      stealthRange = 60 },
    { id = "vampiric",  name = "吸血", tier = 2, color = { 180, 40, 60 },
      vampRate = 0.03 },
    { id = "offensive", name = "攻击", tier = 2, color = { 255, 80, 80 },
      attackRange = 80, attackCooldown = 2.5, attackDamageMult = 5.0 },
...
Config.STAGE_HP_BASE = 1.0
Config.STAGE_HP_PER_STAGE = 0.35
Config.STAGE_HP_EXPO = 1.05
