...
-- 活动标签定义
local ACTIVITY_TABS = {
    { id = "signin",    icon = "image/icon_signin_20260408170600.png",       label = "签到" },
    { id = "daily",     icon = "image/icon_daily_deal_20260408170606.png",   label = "每日特惠" },
    { id = "cumulate",  icon = "image/icon_cumulate_20260408172104.png",     label = "积天好礼" },
    { id = "shop",      icon = "image/icon_fund_shop_20260408170602.png",    label = "基金商城" },
    { id = "vip",       icon = "image/icon_vip_20260408170559.png",          label = "尊享" },
}
...
local function CreateBanner()
    return ctx.UI.Panel {
        ...
        height = "20%",
        flexShrink = 0,
        backgroundImage = "image/activity_header_bg_20260408064829.png",
