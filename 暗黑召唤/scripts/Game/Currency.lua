...
function Currency.Set(currencyId, amount)
    HeroData.currencies[currencyId] = math.max(0, math.floor(amount))
end
...
function Currency.Add(currencyId, amount)
    ...
    HeroData.currencies[currencyId] = (HeroData.currencies[currencyId] or 0) + math.floor(amount)
end
...
function Currency.Spend(currencyId, amount)
    ...
    HeroData.currencies[currencyId] = current - math.floor(amount)
    return true
end
...
function Currency.CollectDarkSoul(amount)
    HeroData.currencies.dark_soul = (HeroData.currencies.dark_soul or 0) + amount
end
