...
-- 标签定义
local TAB_DEFS = {
    { key = "hero",    label = "英雄",   icon = "image/tab_battle_20260408235644.png" },
    { key = "equip",   label = "装备",   icon = "image/tab_equip_20260408235639.png" },
    { key = "battle",  label = "战斗",   icon = "image/tab_hero_20260408235636.png" },
    { key = "chest",   label = "宝箱",   icon = "image/tab_chest_20260408235703.png" },
    { key = "dungeon", label = "副本",   icon = "image/tab_dungeon_20260408235708.png" },
}
