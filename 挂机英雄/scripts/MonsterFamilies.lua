...
local FAMILIES = {
    ...
    undead = {
        ...
        members = {
            swarm    = { name = "骸骨鼠",     image = "Textures/mobs/families/undead_swarm.png" },
            tank     = { name = "骨傀儡",     image = "Textures/mobs/families/undead_tank.png",     resistId = "phys_armor" },
            glass    = { name = "暗影刺客",   image = "Textures/mobs/families/undead_glass.png",    resistId = "all_low" },
            bruiser  = { name = "诅咒骑士",   image = "Textures/mobs/families/undead_bruiser.png" },
            debuffer = { name = "尸蛛",       image = "Textures/mobs/families/undead_debuffer.png", resistId = "poison_res" },
            caster   = { name = "亡灵侍祭",  image = "Textures/mobs/families/undead_caster.png" },
            exploder = { name = "骨爆亡灵",   image = "Textures/mobs/families/undead_exploder.png", resistId = "all_low" },
        },
    },
    ...
    beast = {
        ...
        members = {
            swarm    = { name = "荒原鼠",   image = "Textures/mobs/families/beast_swarm.png" },
            tank     = { name = "巨甲兽",   image = "Textures/mobs/families/beast_tank.png",     resistId = "all_high" },
            glass    = { name = "迅影豹",   image = "Textures/mobs/families/beast_glass.png",    resistId = "all_low" },
            bruiser  = { name = "狂狼",     image = "Textures/mobs/families/beast_bruiser.png" },
            debuffer = { name = "毒蛙",     image = "Textures/mobs/families/beast_debuffer.png", resistId = "poison_res" },
            caster   = { name = "巫蛛",     image = "Textures/mobs/families/beast_caster.png" },
            exploder = { name = "爆蛙",     image = "Textures/mobs/families/beast_exploder.png", resistId = "all_low" },
        },
    },
    ...
    elemental_fire = {
        ...
        members = {
            swarm    = { name = "熔岩蜥蜴",   image = "Textures/mobs/families/fire_swarm.png" },
            tank     = { name = "岩甲巨蝎",   image = "Textures/mobs/families/fire_tank.png",     resistId = "all_high" },
            glass    = { name = "火山飞蛾",   image = "Textures/mobs/families/fire_glass.png",    resistId = "all_low" },
            bruiser  = { name = "熔岩猎犬",   image = "Textures/mobs/families/fire_bruiser.png" },
            debuffer = { name = "毒焰蘑菇",   image = "Textures/mobs/families/fire_debuffer.png", resistId = "poison_res" },
            caster   = { name = "烈焰术士",   image = "Textures/mobs/families/fire_caster.png" },
            exploder = { name = "熔核精灵",   image = "Textures/mobs/families/fire_exploder.png", resistId = "all_low" },
        },
    },
    ...
    elemental_ice = {
        ...
        members = {
            swarm    = { name = "霜魔小鬼",   image = "Textures/mobs/families/ice_swarm.png" },
            tank     = { name = "永冻傀儡",   image = "Textures/mobs/families/ice_tank.png",     resistId = "all_high" },
            glass    = { name = "寒魂幽灵",   image = "Textures/mobs/families/ice_glass.png",    resistId = "all_low" },
            bruiser  = { name = "雪原狼",     image = "Textures/mobs/families/ice_bruiser.png" },
            debuffer = { name = "冰霜蛛",     image = "Textures/mobs/families/ice_debuffer.png" },
            caster   = { name = "冰霜术士",   image = "Textures/mobs/families/ice_caster.png" },
            exploder = { name = "冰封亡灵",   image = "Textures/mobs/families/ice_exploder.png", resistId = "all_low" },
        },
    },
    ...
    elemental_poison = {
        ...
        members = {
            swarm    = { name = "瘟疫甲虫",   image = "Textures/mobs/families/poison_swarm.png" },
            tank     = { name = "铁木树人",   image = "Textures/mobs/families/poison_tank.png",   resistId = "all_high" },
            glass    = { name = "丛林黑豹",   image = "Textures/mobs/families/poison_glass.png",  resistId = "all_low" },
            bruiser  = { name = "荆棘蝮蛇",   image = "Textures/mobs/families/poison_bruiser.png" },
            debuffer = { name = "绞杀藤蔓",   image = "Textures/mobs/families/poison_debuffer.png" },
            caster   = { name = "沼地巫师",   image = "Textures/mobs/families/poison_caster.png" },
            exploder = { name = "孢子潜伏者", image = "Textures/mobs/families/poison_exploder.png", resistId = "all_low" },
        },
    },
    ...
    arcane = {
        ...
        resistProfile = "arcane_res",
        members = {
            swarm    = { name = "虚空游光",   image = "Textures/mobs/families/arcane_swarm.png" },
            tank     = { name = "虚空巨像",   image = "Textures/mobs/families/arcane_tank.png",     resistId = "all_high" },
            glass    = { name = "裂隙潜行者", image = "Textures/mobs/families/arcane_glass.png",    resistId = "all_low" },
            bruiser  = { name = "空间撕裂者", image = "Textures/mobs/families/arcane_bruiser.png" },
            debuffer = { name = "虚无哨兵",   image = "Textures/mobs/families/arcane_debuffer.png" },
            caster   = { name = "相位编织者", image = "Textures/mobs/families/arcane_caster.png" },
            exploder = { name = "熵灭微粒",   image = "Textures/mobs/families/arcane_exploder.png", resistId = "all_low" },
        },
    },
    ...
    divine = {
        ...
        members = {
            swarm    = { name = "辉光精灵",     image = "Textures/mobs/families/divine_swarm.png" },
            tank     = { name = "圣域巨灵",     image = "Textures/mobs/families/divine_tank.png",     resistId = "all_high" },
            glass    = { name = "狂信骑士",     image = "Textures/mobs/families/divine_glass.png",    resistId = "all_low" },
            bruiser  = { name = "光环枪兵",     image = "Textures/mobs/families/divine_bruiser.png" },
            debuffer = { name = "金甲守卫",     image = "Textures/mobs/families/divine_debuffer.png" },
            caster   = { name = "炽天使祈唤者", image = "Textures/mobs/families/divine_caster.png" },
            exploder = { name = "圣光游魂",     image = "Textures/mobs/families/divine_exploder.png", resistId = "all_low" },
        },
    },
    ...
    aquatic = {
        ...
        members = {
            swarm    = { name = "深海灯笼鱼", image = "Textures/mobs/families/aquatic_swarm.png" },
            tank     = { name = "深渊巨蟹",   image = "Textures/mobs/families/aquatic_tank.png",     resistId = "phys_armor" },
            glass    = { name = "风暴海马",   image = "Textures/mobs/families/aquatic_glass.png",    resistId = "all_low" },
            bruiser  = { name = "潮汐鲛人",   image = "Textures/mobs/families/aquatic_bruiser.png" },
            debuffer = { name = "毒刺水母",   image = "Textures/mobs/families/aquatic_debuffer.png", resistId = "poison_res" },
            caster   = { name = "海葵祭司",   image = "Textures/mobs/families/aquatic_caster.png" },
            exploder = { name = "膨胀河豚",   image = "Textures/mobs/families/aquatic_exploder.png", resistId = "all_low" },
        },
    },
}
